...
func NewContext(wranglerCtx *wrangler.Context, steveClient *v1.Client) (*Context, error) {
	return &Context{
		Management:   managementv3.New(wranglerCtx.SharedControllerFactory, steveClient),
		Provisioning: provisioningv1.New(wranglerCtx.SharedControllerFactory, steveClient),
		RKE:          rkev1.New(wranglerCtx.SharedControllerFactory, steveClient),
	}, nil
}
