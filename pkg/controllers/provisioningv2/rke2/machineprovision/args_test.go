...
func TestGetInstanceName(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			data: TestData{
				metav1.ObjectMeta{
					Name: "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789-aa23e",
				},
			},
			expected: "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789-aa23e",
		},
	}
	...
	tests := []struct {
			...
			data: TestData{
				metav1.ObjectMeta{
					Annotations: map[string]string{
						rke2.HostnameLengthLimitAnnotation: "24",
					},
		...
		},
		{
			...
			data: TestData{
				metav1.ObjectMeta{
					Annotations: map[string]string{
						rke2.HostnameLengthLimitAnnotation: "9",
					},
					Name: "abcdef0123456789abcdef0123456789",
				},
			},
		...
		},
		{
			...
			data: TestData{
				metav1.ObjectMeta{
					Annotations: map[string]string{
						rke2.HostnameLengthLimitAnnotation: "64",
					},
					Name: "abcdef0123456789abcdef0123456789",
				},
			},
